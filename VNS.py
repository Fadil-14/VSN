...
\x1b[1;91m█████████
█▄█████▄█      \x1b[1;91m●▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬●            █ ▼▼▼▼▼  _ --_--╔╦╗┌─┐┬─┐┬┌─  1
\033[1;97m█  \033[1;97m_-_-- -_ --__ ║║├─┤├┬┘├┴┐───╠╣ ╠╩╗VNS             █ ▲▲▲▲▲-  - _ --═╩╝┴ ┴┴└─┴ ┴   
█████████      °°°°°°°°°°✧°°°°°°°°°°»
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;96m[●] \x1b[1;93mSedang masuk njing..  \x1b[1;97m"+o),;sys.stdout.flush();time.sleep(1)
...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;91mSiapa nama kamu  ? \033[1;91m: \033[1;92m")
	if nama =="":
...
def loginSC():
	os.system('clear')
	jalan("\033[1;96mSilahkan login SC nya dulu....jangan di salah gunakan && jangan di perjaual belikan info:JIKA AKUN FB KALIAN TIDAK INGIN KENA CP SEBELUM MNH LOGIN DI TERMUX LOGIN DLU DI OPERA MINI/BUAT FB BARU. SUBSCRIBE CHANEL GW NJING...! \n")
	...
	if username =="Fadil-ID" and password =="VNS":
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96mjika loginya berhasil \x1b[1;93mnanti akan di arahkan ke youtube \x1b[1;96mdan kamu harus SUBSCRIBE dulu' )
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mSepertinya akun anda kena checkpoint 😅 SABAR COK")
